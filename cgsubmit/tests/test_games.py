...
class TestGames(unittest.TestCase):
    mocked_games = [
        {"players": [{"position": 1, "nickname": "Player 1"}], "gameId": 105},
        {
            "players": [
                {"position": 0, "nickname": "Player 1"},
                {"position": 1, "nickname": "Player 2"},
            ],
            "gameId": 100,
        },
        {
            "players": [
                {"position": 0, "nickname": "Player 3"},
                {
                    "position": 1,
                    "nickname": "Player 1",
                },
        ...
        try:
            Games(
                [
                    ...
                    {
                        "players": [{"position": 0, "nickname": "Player 1"}],
                        "gameId": 100,
                    },
                ]
            )
    ...
    def test_games_timeouts(self):
        ...
        games = Games(self.mocked_games)
        timeouts = games.get_timeouts([{"scores": [90, 86]}, {"scores": [-1, 0]}])
